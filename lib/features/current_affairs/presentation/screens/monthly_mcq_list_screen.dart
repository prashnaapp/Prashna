...
class MonthlyMcqListScreen extends StatelessWidget {
  const MonthlyMcqListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final sets = CurrentAffairsService.instance.getMonthlySets();

    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(title: const Text('Monthly MCQs')),
      body: SafeArea(
        bottom: false,
