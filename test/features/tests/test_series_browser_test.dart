...
void main() {
  ...
  group('TestSeriesBrowserScreen', () {
    ...
    testWidgets('grand tests show series tabs and paper cards underneath', (
      tester,
    ) async {
      final service = catalog([
        published(
      ...
      await pumpIgnoringFonts(
        ...
        MaterialApp(
          home: TestSeriesBrowserScreen(
            examId: 'group-ii',
            mode: TestSeriesBrowserMode.grandTests,
            testService: service,
          ),
        ),
      );
      ...
      expect(find.text('Paper I Grand Test'), findsOneWidget);
      expect(find.text('Paper II Grand Test'), findsOneWidget);
      expect(find.text('Paper I Grand Test Two'), findsNothing);

      await tester.tap(find.text('set-2'));
      await tester.pumpAndSettle();
      expect(find.text('Paper I Grand Test Two'), findsOneWidget);
      expect(find.text('Paper II Grand Test'), findsNothing);
    });
